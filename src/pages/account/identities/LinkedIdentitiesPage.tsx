  ...
  return (
    <LoginLayout>
      <div className="container mx-auto max-w-2xl py-12 px-4">
        <Link to="/login-success" className="inline-flex items-center gap-1 text-sm text-muted-foreground hover:text-foreground mb-6">
        ...
        <div className="mb-6 flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold flex items-center gap-2">
              <Link2 className="h-6 w-6" /> Linked Identities
            </h1>
            <p className="text-muted-foreground mt-1">External provider accounts connected to your profile</p>
          </div>
